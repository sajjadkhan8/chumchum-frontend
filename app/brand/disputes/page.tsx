...
function DisputeCard({ dispute }: { dispute: Dispute }) {
  ...
  return (
    ...
    >
    <Link
      href={`/brand/disputes/${dispute.id}`}
    ...
    return (
      <div className={`${panelClass} flex flex-col items-center gap-3 py-16 text-center`}>
        ...
        <p className="max-w-xs text-xs text-[#8fa699]">
          If you have an issue with an active order, use the Dispute button on the orders page.
        </p>
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#496159]">Track the status of disputes you&apos;ve opened</p>
          </div>
        </div>
        <Suspense>
          <DisputesContent />
