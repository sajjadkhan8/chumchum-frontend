...
export const creatorPackages: CreatorPackage[] = [
  {
    ...
    dealType: 'paid',
    platform: 'instagram',
    tags: ['Restaurant', 'Riyadh', 'High CTR'],
    isPopular: true,
    ordersCompleted: 41,
    status: 'active',
  ...
  },
  {
    id: 'cp-2',
    creatorId: '1',
    title: 'Jeddah Cafe Barter Story Pack',
    ...
    price: 0,
    dealType: 'barter',
    barterValue: 'Minimum barter SAR 20,000+',
  ...
  },
  {
    ...
    shortDescription: 'SAR 18,000 + weekend stay collaboration package.',
    description: 'SAR 18,000 + weekend stay collaboration package.',
    fullDescription:
    ...
    price: 18000,
    dealType: 'hybrid',
    barterValue: 'Weekend stay worth SAR 45,000+',
