...
export const creatorPackages: CreatorPackage[] = [
  {
    id: 'cp-1',
    creatorId: '1',
    title: 'Karachi Food Reel Sprint',
    ...
    dealType: 'paid',
    platform: 'instagram',
    tags: ['Restaurant', 'Karachi', 'High CTR'],
    isPopular: true,
    ordersCompleted: 41,
    status: 'active',
  ...
  },
  {
    id: 'cp-2',
    creatorId: '1',
    title: 'Lahore Cafe Barter Story Pack',
  ...
  },
  {
    ...
    shortDescription: 'PKR 450,000 + weekend stay collaboration package.',
